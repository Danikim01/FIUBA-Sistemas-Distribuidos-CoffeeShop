...
class ImprovedStateManager(Generic[T]):
    """
...
class ImprovedTPVStateManager(ImprovedStateManager[DefaultDict[ClientId, DefaultDict[str, DefaultDict[int, float]]]]):
    """
...
class ImprovedUsersStateManager(ImprovedStateManager[DefaultDict[ClientId, DefaultDict[int, DefaultDict[int, int]]]]):
    """
...
class ImprovedItemsStateManager(ImprovedStateManager[tuple[DefaultDict[ClientId, DefaultDict[str, DefaultDict[int, int]]], DefaultDict[ClientId, DefaultDict[str, DefaultDict[int, float]]]]]):
    """
